...
while true; do  gst-launch-1.0 filesrc location=$VIDEOLOCATION/vga1.h264 ! video/x-h264,framerate=30/1 ! queue ! h264parse ! rtph264pay config-interval=3 pt=96 mtu=9000 ! udpsink host=192.168.10.255 port=1235 &> /dev/null; done &
while true; do  gst-launch-1.0 filesrc location=$VIDEOLOCATION/vga2.h264 ! video/x-h264,framerate=30/1 ! queue ! h264parse ! rtph264pay config-interval=3 pt=96 mtu=9000 ! udpsink host=192.168.10.255 port=1236 &> /dev/null; done &
while true; do  gst-launch-1.0 filesrc location=$VIDEOLOCATION/vga3.h264 ! video/x-h264,framerate=30/1 ! queue ! h264parse ! rtph264pay config-interval=3 pt=96 mtu=9000 ! udpsink host=192.168.10.255 port=1237 &> /dev/null; done &
